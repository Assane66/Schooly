  ...
  return (
    <>
      ...
      <section className="module-summary-strip">
        ...
        <div className="module-summary-actions"><button className="soft-button" onClick={() => onAction("Importer un fichier d’élèves")}>Importer CSV / Excel <ArrowUpRight size={16} /></button><button className="soft-button" onClick={exportStudents}><Download size={16} /> Exporter CSV</button></div>
      </section>
