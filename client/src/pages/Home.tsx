...
export default function Home() {
  ...
  const requiredPermission: Record<string, string | undefined> = { "Élèves": "students.view", Inscriptions: "registrations.manage", Classes: "classes.manage", Pédagogie: "grades.manage", "Vie scolaire": "attendance.manage", Finances: "payments.view", Documents: "documents.manage", Calendrier: "calendar.manage", "Équipe & rôles": "roles.manage" };
